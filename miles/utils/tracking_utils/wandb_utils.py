...
def _init_wandb_common():
    ...
    wandb.define_metric("score/*", step_metric="rollout/step")
    wandb.define_metric("act/*", step_metric="rollout/step")
    wandb.define_metric("write/*", step_metric="rollout/step")
    wandb.define_metric("sample_length/*", step_metric="rollout/step")
    wandb.define_metric("diagnostics/*", step_metric="rollout/step")
    wandb.define_metric("memory_length/*", step_metric="rollout/step")
    wandb.define_metric("memory/*", step_metric="rollout/step")
    wandb.define_metric("training_signal/*", step_metric="rollout/step")
