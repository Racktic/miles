...
# Usage: nohup bash scripts/train_4b_v3nocurr_grace12.sh > logs/smith-4b-v3nocurr-grace12v2.console.log 2>&1 &
set -euo pipefail
...
export CODEBASE_RUN_ID="smith-4b-v3nocurr-grace12v2"
