#!/usr/bin/env bash
# ACT+WRITE 共训 × 6p6 数据(2026-07-16 用户批准的 WRITE reward 实验)。
# 与 actonly-6p6 的差异, 仅三点:
#   1. WRITE 参与训练, reward = format_ok × 下一题原始reward + 0.1 × format_ok
...
export CODEBASE_RUN_ID="swecl-4b-actwrite-gated_downstream-6p6"
