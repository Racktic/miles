#!/usr/bin/env bash
# lr=0 金丝雀(备用): --sglang-disable-overlap-schedule(2026-07-14)。
# 目的: ping-pong 缩为单 buffer, 消灭 #24954/#26941 竞态源头。
...
export CODEBASE_SGLANG_EXTRA_ARGS="--sglang-disable-overlap-schedule"   # 本实验唯一自变量

export CODEBASE_RUN_ID="swecl-4b-nooverlap-lr0"
